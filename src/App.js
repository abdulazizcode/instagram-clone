...
import logos from "./img/instagram-log.png";
...
const  App= ()=> {
    ...
    //useEffect ---> Runs piese of code besed on a specific condition

    useEffect(()=>{
        db.collection('post').orderBy('timestamp', 'desc').onSnapshot(snapshot=>{
            //every time new post is addedd take a screenshot of it
